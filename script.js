...
document.getElementById('modalCustomer').addEventListener('click',function(e){
    if(e.target===this) fecharModalCustomer();
});
...
function abrirModalEDAP(){
  const m = document.getElementById('modalEDAP');
  m.style.display='flex';
  document.body.style.overflow='hidden';
}

function fecharModalEDAP(){
  const m = document.getElementById('modalEDAP');
  m.style.display='none';
  document.body.style.overflow='auto';
}

document.getElementById('modalEDAP').addEventListener('click',function(e){
    if(e.target===this) fecharModalEDAP();
});
